...
async def info(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        f"""🌈 Annie is not just a bot; she's a gateway to limitless possibilities! Dive into a magical experience with Annie's enchanting features.

🔮 **Features:**
- 🤖 **Smart Conversations:** Annie loves a good chat! Engage in meaningful conversations and let her surprise you.
- 🌐 **Global Insights:** Connect with users worldwide and discover diverse perspectives.
- 🎉 **Fun Interactions:** From games to jokes, Annie knows how to keep the fun alive!
